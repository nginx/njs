...
static const njs_object_prop_init_t  njs_math_object_properties[] =
{
    ...
    NJS_DECLARE_PROP_VALUE(LN10, njs_value(NJS_NUMBER, 1, M_LN10),
                           0),

    NJS_DECLARE_PROP_VALUE(LN2, njs_value(NJS_NUMBER, 1, M_LN2), 0),

    NJS_DECLARE_PROP_VALUE(LOG10E,
                           njs_value(NJS_NUMBER, 1, M_LOG10E), 0),

    NJS_DECLARE_PROP_VALUE(LOG2E, njs_value(NJS_NUMBER, 1, M_LOG2E),
                           0),

    NJS_DECLARE_PROP_VALUE(PI, njs_value(NJS_NUMBER, 1, M_PI), 0),

    NJS_DECLARE_PROP_VALUE(SQRT1_2,
                           njs_value(NJS_NUMBER, 1, M_SQRT1_2), 0),

    NJS_DECLARE_PROP_VALUE(SQRT2, njs_value(NJS_NUMBER, 1, M_SQRT2),
                           0),

    NJS_DECLARE_PROP_NATIVE(abs, njs_object_math_func, 1,
                            NJS_MATH_ABS),

    NJS_DECLARE_PROP_NATIVE(acos, njs_object_math_func, 1,
                            NJS_MATH_ACOS),

    NJS_DECLARE_PROP_NATIVE(acosh, njs_object_math_func, 1,
                            NJS_MATH_ACOSH),

    NJS_DECLARE_PROP_NATIVE(asin, njs_object_math_func, 1,
                            NJS_MATH_ASIN),

    NJS_DECLARE_PROP_NATIVE(asinh, njs_object_math_func, 1,
                            NJS_MATH_ASINH),

    NJS_DECLARE_PROP_NATIVE(atan, njs_object_math_func, 1,
                            NJS_MATH_ATAN),

    NJS_DECLARE_PROP_NATIVE(atan2, njs_object_math_func, 2,
                            NJS_MATH_ATAN2),

    NJS_DECLARE_PROP_NATIVE(atanh, njs_object_math_func, 1,
                            NJS_MATH_ATANH),

    NJS_DECLARE_PROP_NATIVE(cbrt, njs_object_math_func, 1,
                            NJS_MATH_CBRT),

    NJS_DECLARE_PROP_NATIVE(ceil, njs_object_math_func, 1,
                            NJS_MATH_CEIL),

    NJS_DECLARE_PROP_NATIVE(clz32, njs_object_math_func, 1,
                            NJS_MATH_CLZ32),

    NJS_DECLARE_PROP_NATIVE(cos, njs_object_math_func, 1,
                            NJS_MATH_COS),

    NJS_DECLARE_PROP_NATIVE(cosh, njs_object_math_func, 1,
                            NJS_MATH_COSH),

    NJS_DECLARE_PROP_NATIVE(exp, njs_object_math_func, 1,
                            NJS_MATH_EXP),

    NJS_DECLARE_PROP_NATIVE(expm1, njs_object_math_func, 1,
                            NJS_MATH_EXPM1),

    NJS_DECLARE_PROP_NATIVE(floor, njs_object_math_func, 1,
                            NJS_MATH_FLOOR),
    ...
    NJS_DECLARE_PROP_NATIVE(imul, njs_object_math_func, 2,
                            NJS_MATH_IMUL),

    NJS_DECLARE_PROP_NATIVE(log, njs_object_math_func, 1,
                            NJS_MATH_LOG),

    NJS_DECLARE_PROP_NATIVE(log10, njs_object_math_func, 1,
                            NJS_MATH_LOG10),

    NJS_DECLARE_PROP_NATIVE(log1p, njs_object_math_func, 1,
                            NJS_MATH_LOG1P),

    NJS_DECLARE_PROP_NATIVE(log2, njs_object_math_func, 1,
                            NJS_MATH_LOG2),
    ...
    NJS_DECLARE_PROP_NATIVE(pow, njs_object_math_func, 2,
                            NJS_MATH_POW),

    NJS_DECLARE_PROP_NATIVE(random, njs_object_math_random, 0, 0),

    NJS_DECLARE_PROP_NATIVE(round, njs_object_math_func, 1,
                            NJS_MATH_ROUND),

    NJS_DECLARE_PROP_NATIVE(sign, njs_object_math_func, 1,
                            NJS_MATH_SIGN),

    NJS_DECLARE_PROP_NATIVE(sin, njs_object_math_func, 1,
                            NJS_MATH_SIN),

    NJS_DECLARE_PROP_NATIVE(sinh, njs_object_math_func, 1,
                            NJS_MATH_SINH),

    NJS_DECLARE_PROP_NATIVE(sqrt, njs_object_math_func, 1,
                            NJS_MATH_SQRT),

    NJS_DECLARE_PROP_NATIVE(tan, njs_object_math_func, 1,
                            NJS_MATH_TAN),

    NJS_DECLARE_PROP_NATIVE(tanh, njs_object_math_func, 1,
                            NJS_MATH_TANH),

    NJS_DECLARE_PROP_NATIVE(trunc, njs_object_math_func, 1,
                            NJS_MATH_TRUNC),
};
