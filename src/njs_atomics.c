    ...
    njs_value_t *index_val)
{
    ...
    if (type == NJS_OBJ_TYPE_UINT8_CLAMPED_ARRAY
        || type == NJS_OBJ_TYPE_FLOAT32_ARRAY
    ...
    njs_index_t unused, njs_value_t *retval)
{
    ...
    switch (size) {
    case 1:
        lock_free = (ATOMIC_CHAR_LOCK_FREE == 2);
        break;

    case 2:
        lock_free = (ATOMIC_SHORT_LOCK_FREE == 2);
        break;
    ...
    case 8:
        lock_free = (ATOMIC_LLONG_LOCK_FREE == 2);
        break;
