...
NJS_DEF_STRING(unknown, "unknown",  0x00, NJS_TOKEN_ILLEGAL)
...
NJS_DEF_STRING(arguments, "arguments",  0x02, NJS_TOKEN_ARGUMENTS)
NJS_DEF_STRING(async, "async",          0x02, NJS_TOKEN_ASYNC)
NJS_DEF_STRING(await, "await",          0x03, NJS_TOKEN_AWAIT)
NJS_DEF_STRING(break, "break",          0x03, NJS_TOKEN_BREAK)
NJS_DEF_STRING(case, "case",            0x03, NJS_TOKEN_CASE)
NJS_DEF_STRING(catch, "catch",          0x03, NJS_TOKEN_CATCH)
NJS_DEF_STRING(class, "class",          0x03, NJS_TOKEN_CLASS)
NJS_DEF_STRING(const, "const",          0x03, NJS_TOKEN_CONST)
NJS_DEF_STRING(continue, "continue",    0x03, NJS_TOKEN_CONTINUE)
NJS_DEF_STRING(debugger, "debugger",    0x03, NJS_TOKEN_DEBUGGER)
NJS_DEF_STRING(default, "default",      0x03, NJS_TOKEN_DEFAULT)
NJS_DEF_STRING(delete, "delete",        0x03, NJS_TOKEN_DELETE)
NJS_DEF_STRING(do, "do",                0x03, NJS_TOKEN_DO)
NJS_DEF_STRING(else, "else",            0x03, NJS_TOKEN_ELSE)
NJS_DEF_STRING(enum, "enum",            0x03, NJS_TOKEN_ENUM)
NJS_DEF_STRING(eval, "eval",            0x02, NJS_TOKEN_EVAL)
NJS_DEF_STRING(export, "export",        0x03, NJS_TOKEN_EXPORT)
NJS_DEF_STRING(extends, "extends",      0x03, NJS_TOKEN_EXTENDS)
NJS_DEF_STRING(false, "false",          0x03, NJS_TOKEN_FALSE)
NJS_DEF_STRING(finally, "finally",      0x03, NJS_TOKEN_FINALLY)
NJS_DEF_STRING(for, "for",              0x03, NJS_TOKEN_FOR)
NJS_DEF_STRING(from, "from",            0x02, NJS_TOKEN_FROM)
NJS_DEF_STRING(function, "function",    0x03, NJS_TOKEN_FUNCTION)
NJS_DEF_STRING(if, "if",                0x03, NJS_TOKEN_IF)
NJS_DEF_STRING(implements, "implements",0x03, NJS_TOKEN_IMPLEMENTS)
NJS_DEF_STRING(import, "import",        0x03, NJS_TOKEN_IMPORT)
NJS_DEF_STRING(in, "in",                0x03, NJS_TOKEN_IN)
NJS_DEF_STRING(instanceof, "instanceof",0x03, NJS_TOKEN_INSTANCEOF)
NJS_DEF_STRING(interface, "interface",  0x03, NJS_TOKEN_INTERFACE)
NJS_DEF_STRING(let, "let",              0x03, NJS_TOKEN_LET)
NJS_DEF_STRING(meta, "meta",            0x02, NJS_TOKEN_META)
NJS_DEF_STRING(new, "new",              0x03, NJS_TOKEN_NEW)
NJS_DEF_STRING(null, "null",            0x03, NJS_TOKEN_NULL)
NJS_DEF_STRING(of, "of",                0x02, NJS_TOKEN_OF)
NJS_DEF_STRING(package, "package",      0x03, NJS_TOKEN_PACKAGE)
NJS_DEF_STRING(private, "private",      0x03, NJS_TOKEN_PRIVATE)
NJS_DEF_STRING(protected, "protected",  0x03, NJS_TOKEN_PROTECTED)
NJS_DEF_STRING(public, "public",        0x03, NJS_TOKEN_PUBLIC)
NJS_DEF_STRING(return, "return",        0x03, NJS_TOKEN_RETURN)
NJS_DEF_STRING(static, "static",        0x03, NJS_TOKEN_STATIC)
NJS_DEF_STRING(super, "super",          0x03, NJS_TOKEN_SUPER)
NJS_DEF_STRING(switch, "switch",        0x03, NJS_TOKEN_SWITCH)
NJS_DEF_STRING(target, "target",        0x02, NJS_TOKEN_TARGET)
NJS_DEF_STRING(this, "this",            0x03, NJS_TOKEN_THIS)
NJS_DEF_STRING(throw, "throw",          0x03, NJS_TOKEN_THROW)
NJS_DEF_STRING(true, "true",            0x03, NJS_TOKEN_TRUE)
NJS_DEF_STRING(try, "try",              0x03, NJS_TOKEN_TRY)
NJS_DEF_STRING(typeof, "typeof",        0x03, NJS_TOKEN_TYPEOF)
NJS_DEF_STRING(undefined, "undefined",  0x02, NJS_TOKEN_UNDEFINED)
NJS_DEF_STRING(var, "var",              0x03, NJS_TOKEN_VAR)
NJS_DEF_STRING(void, "void",            0x03, NJS_TOKEN_VOID)
NJS_DEF_STRING(while, "while",          0x03, NJS_TOKEN_WHILE)
NJS_DEF_STRING(with, "with",            0x03, NJS_TOKEN_WITH)
NJS_DEF_STRING(yield, "yield",          0x03, NJS_TOKEN_YIELD)
