...
NJS_DEF_STRING(Atomics, "Atomics", 0, 0)
NJS_DEF_STRING(add, "add", 0, 0)
NJS_DEF_STRING(and, "and", 0, 0)
NJS_DEF_STRING(compareExchange, "compareExchange", 0, 0)
NJS_DEF_STRING(exchange, "exchange", 0, 0)
NJS_DEF_STRING(isLockFree, "isLockFree", 0, 0)
NJS_DEF_STRING(load, "load", 0, 0)
NJS_DEF_STRING(or, "or", 0, 0)
NJS_DEF_STRING(store, "store", 0, 0)
NJS_DEF_STRING(sub, "sub", 0, 0)
NJS_DEF_STRING(xor, "xor", 0, 0)
